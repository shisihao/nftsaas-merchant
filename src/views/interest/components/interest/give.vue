<template>
  <div>
    ...
    <el-form-item v-if="form.interests.give.type === 'long'" label="是否开启">
      <el-switch
    ...
    <el-form-item
      v-if="['once'].includes(form.interests.give.type)"
      label="权益次数"
    ...
    >
      <el-input-number
        v-model="form.interests.give.give_days"
        :min="1"
        :precision="0"
        label="藏品转赠解锁时间(天)"
      />
    ...
    <div v-if="form.interests.give.type === 'appoint'">
      <el-form-item
        label="指定藏品"
        prop="interests.give.buy.goods"
        :rules="{
      ...
      >
        <el-select
          v-model="form.interests.give.buy.goods"
          class="select-input"
          filterable
          multiple
          clearable
      ...
      >
        <el-select
          v-model="form.interests.give.buy.box"
          class="select-input"
          filterable
          multiple
          clearable
