  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        cate_id: [
          { required: true, message: '请选择藏品分类', trigger: ['blur', 'change'] }
        ],
        stock: [
        ...
        is_more: [
          { required: true, message: '请选择是否多次销售', trigger: ['blur', 'change'] }
        ],
        total_stock: [
        ...
        is_hot: [
          { required: true, message: '请选择是否热销', trigger: ['blur', 'change'] }
        ]
      }
    }
  },
  ...
  methods: {
    ...
    conditionLists() {
      conditionList().then(response => {
        this.conditionOptions.push(...response.data.map(v => {
          return {
            label: v.name,
            value: v.id
          }
